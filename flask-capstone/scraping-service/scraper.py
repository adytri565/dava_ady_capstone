...
# 1. KONEKSI MONGODB UNTUK SCRAPING
...
def run_automated_scraping():
    ...
    try:
        ...
        for item in items:
            ...
            if is_duplicate:
                duplicate_count += 1
                continue # Skip/buang data duplikat agar tidak tersimpan ganda
        ...
        print(f"Scraping Selesai! Tersimpan: {saved_count} berita baru. Dihapus (Duplikat): {duplicate_count}")
...
# ID 'scrape_job' diset agar durasi interval bisa diubah secara dinamis dari panel web
...
# Rute untuk mengubah interval otomatisasi jadwal dari Web UI Control Panel
...
def update_schedule():
    ...
    try:
        ...
        print(f"Jadwal otomatisasi berhasil diubah menjadi {hours} jam sekali.")
...
if __name__ == '__main__':
    # Jalankan sekali saat pertama kali server dinyalakan (opsional)
